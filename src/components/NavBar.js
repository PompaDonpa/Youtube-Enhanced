...
function NavBar() {
    ...
    return (
      <div className={classes.root}>
        ...
        variant="dot"
      >
        <Avatar alt="egghead" src="https://api.iconify.design/logos:egghead.svg" className={classes.egg}/>
      </StyledBadge>
          </Toolbar>
        </AppBar>
      </div>
