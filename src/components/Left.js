...
function Left() {
    ...
    return (
      <div className={classes.root}>
        ...
        label="PD"
         onClick={()=>{window.alert('@PompaDonpa')}}
        variant="outlined"
      /> 
           </div>
